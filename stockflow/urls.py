...
urlpatterns = [
    ...
    path('email_template/', TemplateView.as_view(template_name='account/email_template.html'), name='email_template'),
    ...
    # reset password urls
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name="account/password_reset_form.html", html_email_template_name='account/email_template.html', form_class=CustomPasswordResetForm), name='password_reset'),
