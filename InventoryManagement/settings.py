...
INSTALLED_APPS = [
    ...
    'stockflow.apps.StockflowConfig',
    'social_django',
    'django_extensions',
    'debug_toolbar',
]
...
AUTHENTICATION_BACKENDS = [
    ...
    'stockflow.authentication.EmailAuthBackend',
    'social_core.backends.google.GoogleOAuth2',

]

SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = env.str("OAUTH2_KEY")
...
SOCIAL_AUTH_PIPELINE = [
    ...
    'stockflow.authentication.create_profile',
...
INTERNAL_IPS = [
    '127.0.0.1',  # Add your local development IP here
]
